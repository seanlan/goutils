...
func NewAesRequestMiddleware(key string) gin.HandlerFunc {
	return NewEncryptRequestMiddleware(AesEncryptor{key: key})
}

func NewAesResponseMiddleware(key string) gin.HandlerFunc {
	return NewEncryptResponseMiddleware(AesEncryptor{key: key})
}
...
func (a AesEncryptor) Decrypt(source string) (string, error) {
	return AesDecrypt(source, a.key)
}

func (a AesEncryptor) Encrypt(dec string) (string, error) {
	return AesEncrypt(dec, a.key)
}
